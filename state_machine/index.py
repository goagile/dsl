...
class Controller:
    ...
    def handle(self, event_code):
        if self.current_state.has_transition(event_code):
            self.transition_to(self.current_state.target_state(event_code))
        elif self.machine.is_reset_event(event_code):
